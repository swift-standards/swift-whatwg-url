...
struct URLTests {
    ...
    func specialSchemes() throws {
        ...
        #expect(!WHATWG_URL.URL.Scheme.isSpecial("mailto"))
        #expect(!WHATWG_URL.URL.Scheme.isSpecial("data"))
    }
