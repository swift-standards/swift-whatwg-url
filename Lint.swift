...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-whatwg-url open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-whatwg-url project authors
