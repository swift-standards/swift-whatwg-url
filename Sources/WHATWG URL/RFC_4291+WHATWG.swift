...
// REFACTOR TO WORK LIKE SERIALIZABLE DOES WITH BUFFER ON BYTES
...
//        }
//
//        // Parse IPv6 part (must end with ::)
//        guard ipv6Part.hasSuffix(":") else { return nil }
//
//        let ipv6Prefix = String(ipv6Part.dropLast())
//        let parts = ipv6Prefix.split(separator: ":", omittingEmptySubsequences: false)
//
//        var pieces: [UInt16] = []
//
//        for part in parts {
//            if part.isEmpty {
//                // Compression - fill with zeros
//                let zerosCount = 6 - pieces.count
